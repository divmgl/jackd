 ...
 */
export type CommandHandler<T> = (chunk: Uint8Array, command: Uint8Array) => T | Promise<T>;
/**
...
export type JackdArgs = JackdPutArgs | JackdReleaseArgs | JackdPauseTubeArgs | JackdJobArgs | JackdTubeArgs | JackdBuryArgs | never[] | number[] | string[] | [jobId: number, priority?: number];
/**
 * Client options
 */
...
export declare const RESERVED = "RESERVED";
export declare const INSERTED = "INSERTED";
export declare const USING = "USING";
export declare const TOUCHED = "TOUCHED";
export declare const DELETED = "DELETED";
export declare const BURIED = "BURIED";
export declare const RELEASED = "RELEASED";
export declare const NOT_FOUND = "NOT_FOUND";
export declare const OUT_OF_MEMORY = "OUT_OF_MEMORY";
export declare const INTERNAL_ERROR = "INTERNAL_ERROR";
export declare const BAD_FORMAT = "BAD_FORMAT";
export declare const UNKNOWN_COMMAND = "UNKNOWN_COMMAND";
export declare const EXPECTED_CRLF = "EXPECTED_CRLF";
export declare const JOB_TOO_BIG = "JOB_TOO_BIG";
export declare const DRAINING = "DRAINING";
export declare const TIMED_OUT = "TIMED_OUT";
export declare const DEADLINE_SOON = "DEADLINE_SOON";
export declare const FOUND = "FOUND";
export declare const WATCHING = "WATCHING";
export declare const NOT_IGNORED = "NOT_IGNORED";
export declare const KICKED = "KICKED";
